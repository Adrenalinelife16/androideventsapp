...
public class MainActivity extends CustomActivity
{
	...
	private ArrayList<Data> getDummyLeftNavItems()
	{
		...
		al.add(new Data("Activity Feed", R.drawable.ic_nav1, R.drawable.ic_nav1_sel));
		al.add(new Data("Social Feed", R.drawable.ic_nav2, R.drawable.ic_nav2_sel));
		al.add(new Data("My Activities", R.drawable.ic_nav3,
	...
	private void setActionBarTitle()
	{
		...
		getActionBar().setLogo(R.mipmap.ic_adrenaline_logo);
	}
